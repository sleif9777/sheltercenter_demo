...
def get_and_update_dogs():
    ...
    for dog_json in dogs:
        ...
        dog = DogProfile.objects.update_or_create(
...
def check_for_updated_status():
    available_dogs = DogProfile.objects.get(shelterluv_status="Available for Adoption")
...
def display_list(request):
    ...
    all_available_dogs = {dog for dog in DogProfile.objects.filter(shelterluv_status='Available for Adoption').order_by('name')}
