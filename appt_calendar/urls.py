...
urlpatterns = [
    ...
    path("<str:role>/date/<int:date_year>/<int:date_month>/<int:date_day>/print/", views.calendar_print, name="calendar_print"),
    path("<str:role>/reports/date/<int:date_year>/<int:date_month>/<int:date_day>/all/", views.daily_report_all_appts, name="daily_report_all_appts"),
    path("<str:role>/reports/date/<int:date_year>/<int:date_month>/<int:date_day>/adoption_chosen_fta/", views.daily_report_adopted_chosen_fta, name="daily_report_adopted_chosen_fta"),
