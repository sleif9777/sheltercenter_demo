...
urlpatterns = [
    ...
    path('add_announcement/date/<int:date_year>/<int:date_month>/<int:date_day>/', views.add_daily_announcement, name="add_daily_announcement"),
    path('edit_announcement/<int:announcement_id>/date/<int:date_year>/<int:date_month>/<int:date_day>/', views.edit_daily_announcement, name="edit_daily_announcement"),
